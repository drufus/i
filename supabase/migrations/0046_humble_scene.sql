/*
  ...
  1. New Tables
    - `api_keys`
      ...
      - `name` (text, not null)
      - `value` (text, not null)
      - `environment` (text, check constraint for 'development' or 'production')
  ...
  2. Security
    ...
    - Add function to update API keys
    - Add function to get API keys

  3. Initial Data
    - Insert default empty API keys for Stripe
*/
...
VALUES 
  ...
  ('stripe_webhook_domain', 'instacraft.ai', 'production')
